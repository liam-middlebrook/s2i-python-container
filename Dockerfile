...
RUN yum install -y centos-release-scl-rh && \
    ...
    INSTALL_PKGS="rh-python35 rh-python35-python-devel rh-python35-python-setuptools rh-python35-python-pip nss_wrapper httpd httpd-devel atlas-devel gcc-gfortran libffi-devel postgresql-devel openssl-devel openldap-devel" && \
